...
class SMSService
{
    ...
    {
        $this->apiKey = config('hypermsg.msgplus_api_key');
        $this->baseUrl = rtrim(config('hypermsg.msgplus_base_url'), '/');
        $this->senderId = config('hypermsg.msgplus_sender_id');
        $this->templateId = config('hypermsg.msgplus_template_id');
    }
